...
const EN_TO_ZH: &[(&str, &str)] = &[
    ...
    ("Hide Diesel+UG mints", "隐藏 Diesel+UG 铸造"),
    ("Latest Traces", "最新跟踪"),
    ("Latest blocks:", "最新区块:"),
